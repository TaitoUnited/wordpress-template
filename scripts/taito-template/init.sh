...
cat temp > docker-nginx.conf
  ...
  sed ${sedi} -- '/wordpress-template-admin/d' docker-compose.yaml
...
cat temp > docker-compose.yaml
  ...
  sed ${sedi} -- '/wordpress-template-bot/d' docker-compose.yaml
...
cat temp > docker-nginx.conf
  ...
  sed ${sedi} -- '/wordpress-template-client/d' docker-compose.yaml
...
cat temp > docker-compose.yaml
  ...
  sed ${sedi} -- '/wordpress-template-database/d' docker-compose.yaml
...
cat temp > docker-nginx.conf
  ...
  sed ${sedi} -- '/wordpress-template-server/d' docker-compose.yaml
...
cat temp > docker-compose.yaml
  ...
  sed ${sedi} -- '/wordpress-template-storage/d' docker-compose.yaml
...
cat temp > docker-compose.yaml
  ...
  sed ${sedi} -- '/wordpress-template-worker/d' docker-compose.yaml
...
cat temp > docker-compose.yaml
  ...
  sed ${sedi} -- '/wordpress-template-queue/d' docker-compose.yaml
...
cat temp > docker-compose.yaml
  ...
  sed ${sedi} -- '/wordpress-template-cache/d' docker-compose.yaml
